...
| `style-book.md` | Финальная сборка: из выходов `formula-diagnostic` + `look-generator` и 4 баз собирает Style Book (9 разделов) в tone of voice Ксении. Возвращает JSON по разделам. Эталон — `cases/2026-06-09-client-mishel-style-book.md` | ✅ v1.0, требует валидации Ксенией |
