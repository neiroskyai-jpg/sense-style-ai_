...
MODELS = {
    ...
    "image": {
        ...
        # По умолчанию GPT-image: предметная съёмка — его сильная сторона, а отказ от лиц тут
        # не срабатывает, людей в кадре нет. Дешевле Gemini и рисует чище фон и раскладку.
        # Не понравится — SENSE_FLATLAY_MODEL=google/gemini-3-pro-image-preview вернёт как было,
        # на персональные образы это не влияет вообще.
        "flatlay": os.getenv("SENSE_FLATLAY_MODEL", "openai/gpt-5-image"),
    },
}
